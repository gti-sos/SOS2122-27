...
var app = (function () {
    ...
    /* src\front\public_expenditure_stats\PEStatsTable.svelte generated by Svelte v3.46.6 */

    const { console: console_1 } = globals;
    const file$1 = "src\\front\\public_expenditure_stats\\PEStatsTable.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Gasto público";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "% de gasto público respecto a PIB";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "% destinado a defensa en GP";
    			t9 = space();
    			tbody = element("tbody");
    ...
    function create_fragment$1(ctx) {
    	...
    	handle_promise(promise = /*stats*/ ctx[0], info);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*stats*/ 1 && promise !== (promise = /*stats*/ ctx[0]) && handle_promise(promise, info)) ; else {
    ...
    /* src\front\public_expenditure_stats\PEStats.svelte generated by Svelte v3.46.6 */
    const file = "src\\front\\public_expenditure_stats\\PEStats.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	let pestatstable;
    	let current;
    	pestatstable = new PEStatsTable({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Estadísticas de gasto público";
    			t1 = space();
    			create_component(pestatstable.$$.fragment);
    			add_location(h1, file, 7, 1, 89);
    			add_location(main, file, 6, 0, 80);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			mount_component(pestatstable, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(pestatstable.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(pestatstable.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(pestatstable);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('PEStats', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<PEStats> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ PEStatsTable });
    	return [];
    }

    class PEStats extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
